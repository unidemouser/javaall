...
public class GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Enter Temperature in Degree Celcius:");
...
//        try{
//            double user=Double.parseDouble(jTextField1.getText());
//            double fah=(user*9.0/5.0)+32;
//            double kelvin=user+273.15;
//            jLabel5.setText(fah+"");
...
//        }
        try{
            double user=Double.parseDouble(jTextField1.getText());
            double fah=user*9.0/5+32;
            double kel=user+273.15;
            jLabel5.setText(fah+"");
            jLabel6.setText(kel+"");
        }catch(NumberFormatException e){
